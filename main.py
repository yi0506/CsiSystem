...
if __name__ == '__main__':
    ...
    tdfista = TDFISTANet(5, 4)  # macs 94699520.0  params 2287248
    rmnet = RMNet(8)  # macs 11352064.0  2108700.0
    rmnet_stu = RMNetStu(16)  # macs 2603008.0  params 2100174.0
    csinet = CsiNet(32)
    
    
    input = torch.randn(1, 2048)
    macs, params = profile(rmnet_stu, inputs=(input, 1))  # macs 5638144.0  params 2103120.0
